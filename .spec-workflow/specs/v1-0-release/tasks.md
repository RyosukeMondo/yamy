...
- [x] 3.2 Generate baseline coverage report and identify gaps
...
- [x] 4.2 Test on Fedora 40 with GNOME Wayland (native Wayland)
...
- [x] 4.3 Test on Arch Linux with KDE Plasma
...
- [x] 5.2 Create Fedora/SUSE .rpm package with CPack
...
- [x] 5.4 Write CHANGELOG.md and RELEASE-NOTES-1.0.md
...
- [x] 5.5 Set up GitHub Actions release workflow
...
- [x] 6.2 Verify all v1.0 release criteria met
