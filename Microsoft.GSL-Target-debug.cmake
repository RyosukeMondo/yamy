...
########## COMPONENTS TARGET PROPERTIES Debug ########################################
    ...
    ########## COMPONENT Microsoft.GSL::GSL #############
        ...
        set_property(TARGET Microsoft.GSL::GSL APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Debug>:${ms-gsl_Microsoft.GSL_GSL_LINKER_FLAGS_DEBUG}>)
        set_property(TARGET Microsoft.GSL::GSL APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Debug>:${ms-gsl_Microsoft.GSL_GSL_INCLUDE_DIRS_DEBUG}>)
        set_property(TARGET Microsoft.GSL::GSL APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Debug>:${ms-gsl_Microsoft.GSL_GSL_LIB_DIRS_DEBUG}>)
        set_property(TARGET Microsoft.GSL::GSL APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Debug>:${ms-gsl_Microsoft.GSL_GSL_COMPILE_DEFINITIONS_DEBUG}>)
        set_property(TARGET Microsoft.GSL::GSL APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Debug>:${ms-gsl_Microsoft.GSL_GSL_COMPILE_OPTIONS_DEBUG}>)


    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET Microsoft.GSL::GSL APPEND PROPERTY INTERFACE_LINK_LIBRARIES Microsoft.GSL::GSL)
